  ...
  return (
    <div className="flex flex-col h-[calc(100vh-5rem)] bg-background">
      <div className="p-4 md:p-6 pb-4 flex items-center gap-4 border-b border-border">
        ...
        <div>
          <h1 className="text-xl font-bold text-foreground">SCORE2 & SCORE2-OP</h1>
          <p className="text-xs text-muted-foreground">Riesgo CV Europeo</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-muted-foreground max-w-md mb-8 leading-relaxed">
          Por razones de seguridad, las plataformas oficiales como U-Prevent bloquean la visualización directa dentro de otras aplicaciones (X-Frame-Options). 
          <br /><br />
          Para usar el <strong>SCORE2</strong> oficial actualizado, debés abrirlo en una pestaña nueva.
        </p>
        
        <a 
          href="https://u-prevent.com/calculators/score2" 
          target="_blank" 
        ...
        >
          <span>Abrir Calculadora SCORE2</span>
