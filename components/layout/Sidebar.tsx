  ...
  return (
    <div className="flex h-full flex-col bg-slate-950 p-4">
      <div className="mb-8 px-2">
        ...
        <p className="text-xs text-slate-500 mt-1">Herramientas de Guardia</p>
      </div>
      ...
      <div className="mt-auto px-2 pb-4 space-y-2">
        ...
        <button 
          ...
          className="w-full text-left p-3 rounded-xl bg-slate-900 border border-slate-700 text-xs text-slate-300 hover:bg-slate-800 transition-colors flex items-center justify-between"
        >
        ...
        <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800">
          <p className="text-xs text-slate-400">Modo Offline Activo</p>
